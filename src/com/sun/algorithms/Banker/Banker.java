package com.sun.algorithms.Banker;
...
public class Banker {
	 ...
	 * 由艾兹格·迪杰斯特拉在1965年为T.H.E系统设计的一种避免死锁产生的算法。 它以银行借贷系统的分配策略为基础，判断并保证系统的安全运行。
	...
	public void getData() {
		System.out.println("please input the resource num of A,B,C :");
		for (int i = 0; i < 3; i++) {
